...
class X { int b; }
// (class X (BASE_CLASSES (BASE_CLASS (REF_IDENTIFIER Y)) (BASE_CLASS (REF_IDENTIFIER Z))) (DEF_FUNC b (REF_IDENTIFIER int) PARAMETER_LIST FUNCTION_BODY))  
class X : Y, Z { int b() { } }
// (class X (new PARAMETER_LIST FUNCTION_BODY) (delete PARAMETER_LIST FUNCTION_BODY))  
class X { new () {} delete() {} }
// (class X (DEF_FUNC b (REF_IDENTIFIER int) PARAMETER_LIST FUNCTION_BODY) (invariant BLOCK_STATEMENT))
...
// (struct S1 (DEF_VAR (REF_IDENTIFIER int) fieldA) (new PARAMETER_LIST FUNCTION_BODY))
...
// (class C1 (this (PARAMETER_LIST (FUNC_PARAM (REF_IDENTIFIER int) a)) FUNCTION_BODY))
class C1 { this(int a) { } }
